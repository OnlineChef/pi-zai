export function utcDayFromMs(timestampMs) {
    return new Date(timestampMs).toISOString().slice(0, 10);
}
export function endpointKindFromProvider(provider) {
...
export function mergeAnonymousDailySummaries(summaries) {
...
//# sourceMappingURL=anonymous-daily.js.map
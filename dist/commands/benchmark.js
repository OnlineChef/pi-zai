import { BENCHMARK_SCENARIOS, BENCHMARK_VARIANTS, formatBenchmarkInstructions, formatBenchmarkManifest, } from "../benchmark/manifest.js";
const ACTIONS = ["manifest", "instructions"];
export function registerZaiBenchmarkCommand(pi) {
